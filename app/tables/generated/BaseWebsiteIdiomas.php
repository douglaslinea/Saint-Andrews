 ...
 * @property Doctrine_Collection $GjpAcoesNoticias
 * @property Doctrine_Collection $GjpAcoesSociais
 * @property Doctrine_Collection $GjpConvenios
 * @property Doctrine_Collection $GjpFatos
 * @property Doctrine_Collection $GjpLinhaTempo
 * @property Doctrine_Collection $GjpParceiros
...
abstract class BaseWebsiteIdiomas extends Doctrine_Record
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('GjpAcoesNoticias', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));

        $this->hasMany('GjpAcoesSociais', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));

        $this->hasMany('GjpConvenios', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));

        $this->hasMany('GjpFatos', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));

        $this->hasMany('GjpLinhaTempo', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));

        $this->hasMany('GjpParceiros', array(
             'local' => 'cod_id',
             'foreign' => 'cod_idioma'));
