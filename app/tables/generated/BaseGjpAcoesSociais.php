 ...
 */
abstract class BaseGjpAcoesSociais extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('gjpAcoesSociais');
        ...
        $this->hasColumn('txt_historico', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,
