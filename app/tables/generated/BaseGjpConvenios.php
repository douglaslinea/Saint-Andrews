 ...
 * @property string $txt_convenio
 * @property string $img_convenio
 ...
 */
abstract class BaseGjpConvenios extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('gjpConvenios');
        ...
        $this->hasColumn('txt_convenio', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('img_convenio', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,
