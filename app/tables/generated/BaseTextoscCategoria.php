 ...
 */
abstract class BaseTextoscCategoria extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('textoscCategoria');
        ...
        $this->hasColumn('cod_hotel_destino', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => true,
        ...
        $this->hasColumn('cod_optCategoria', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => true,
